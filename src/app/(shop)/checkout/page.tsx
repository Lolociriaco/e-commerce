            ...
            <div className="flex flex-col w-full max-w-[1200px] mx-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="flex flex-col">
                        <Link className="btn-primary mb-10 text-center" href="/cart">
                            Editar carrito
                        </Link>
                        ...
                        <div className="mt-24 w-full">
                            ...
                            <p className="mt-3">
                                <span className="text-xs">
                                    Al hacer click en "Confirmar compra" aceptas los <a href="/terms" className="underline">términos y condiciones</a> de compra
                                </span>
                            </p>

                            <Link href="/orders/898" className="flex justify-center mt-2 btn-primary">
                                Confirmar compra
                            </Link>
                        </div>
